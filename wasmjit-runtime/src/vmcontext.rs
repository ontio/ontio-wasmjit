...
use core::any::Any;
use core::{ptr, u32};
use ontio_wasmjit_environ::BuiltinFunctionIndex;
...
mod test_vmfunction_import {
    ...
    use ontio_wasmjit_environ::{Module, VMOffsets};
...
mod test_vmshared_signature_index {
    ...
    use core::mem::size_of;
    use ontio_wasmjit_environ::{Module, TargetSharedSignatureIndex, VMOffsets};
...
impl VMBuiltinFunctionsArray {
    ...
    pub fn initialized() -> Self {
        ...
        ptrs[BuiltinFunctionIndex::get_memory32_grow_index().index() as usize] =
            wasmjit_memory32_grow as usize;
...
///
/// It is a DST type, as the sizes of these fields are dynamic, we can't describe them in Rust's type
/// system. Sufficient memory is allocated at runtime.
/// The data layout is: \[signature\] + \[imported function\] +
/// \[table definition\] + \[memory definition\] + \[global\] +\[builtin function\]
#[derive(Debug)]
#[repr(C)]
