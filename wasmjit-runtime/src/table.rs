...
use cranelift_wasm::{Table as WasmTable, TableElementType};
...
impl Table {
    ...
    pub fn new(table: &WasmTable) -> Self {
        match table.ty {
        ...
        Self {
            vec: vec![VMCallerCheckedAnyfunc::default(); usize::try_from(table.minimum).unwrap()],
